...
initial_number, ending_number = 1 * 5226, 1 * 5226 + 5226
...
# print("The rf accuracy is: ", rf_accuracy)

clf = MLPClassifier(activation='logistic', alpha=0, hidden_layer_sizes=(10, 4), learning_rate='adaptive',
learning_rate_init=0.0001, max_iter=20000, early_stopping=True, validation_fraction=0.1)
clf.fit(train_features, train_labels)
ann_accuracy = evaluate(clf, test_features, test_labels, 'ann')
print("The ann accuracy is: ", ann_accuracy)
