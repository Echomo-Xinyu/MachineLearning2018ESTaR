...
lowest_mean_index_a, lowest_mean_index_b = 0, 0
lowest_day_mean = 20
day_index = 0
for j in range(365):
    ...
    if lowest_day_mean > current_day_mean:
        lowest_day_mean = current_day_mean
        lowest_mean_index_a, lowest_mean_index_b = indexa, indexb
        day_index = j

print("Lowest day mean is: ", lowest_day_mean)
print("The corresponding index is: ", day_index, " ",lowest_mean_index_a , " ", lowest_mean_index_b)
