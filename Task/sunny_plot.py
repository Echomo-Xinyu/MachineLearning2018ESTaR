# The file is to complete a plot including four trends on a sunny day (Day 218)
# [20928:21024] at BukitTimah (Station 40) to analyze their performance.
import math
import numpy as np
import pandas as pd
import datetime
...
plt.figure(figsize=(20, 12.38))
plt.plot(DateTime[20928:21024], y_prediction[20928:21024], 'rx', label="Actual observation", markersize=12)
plt.plot(DateTime[20928:21024], y_prediction_pre[20928:21024], 'b--', linewidth=3, label="KNN model")
...
plt.plot(DateTime[20928:21024], y_true_pre_svm[20928:21024], 'g--', linewidth=3, label="SVC model")
...
plt.plot(DateTime[20928:21024], y_true_pre_rf[20928:21024], 'm--', linewidth=3, label="RF model")
...
plt.plot(DateTime[20928:21024], y_train_pre[20928:21024], 'y--', linewidth=3, label="SARIMAX model")

plt.title("Figure 4: CSR prediction by SVC, RF, KNN, and SARIMAX models on 7th August 2018 at Bukit Timah (A sunny day specially picked)", fontsize=20)
plt.xticks(fontsize=20)
plt.xlabel("Time (MM-DD HH)", fontsize=20)
plt.yticks(fontsize=20)
plt.ylabel("CSR value", fontsize=20)
plt.legend(fontsize=20)
plt.savefig("SunnyDay_overall_plots.png", format="png")
plt.close()