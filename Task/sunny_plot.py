...
plt.plot(DateTime[20928:21024], y_prediction[20928:21024], 'r+', label="Actual observation")
plt.plot(DateTime[20928:21024], y_prediction_pre[20928:21024], 'b--', linewidth=1, label="KNN model")
...
plt.plot(DateTime[20928:21024], y_true_pre_svm[20928:21024], 'g--', linewidth=1, label="SVC model")
...
plt.plot(DateTime[20928:21024], y_true_pre_rf[20928:21024], 'm--', linewidth=1, label="RF model")
...
plt.plot(DateTime[20928:21024], y_train_pre[20928:21024], 'y--', linewidth=1, label="SARIMAX model")

plt.title("CSR prediction by SVC, RF, KNN, and SARIMAX models on 7th August 2018 at Bukit Timah (A sunny day specially picked)")
plt.xlabel("Time")
