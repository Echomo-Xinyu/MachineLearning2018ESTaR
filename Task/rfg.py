...
random_forest_regressor = RandomForestRegressor(n_estimators=500, oob_score=True, min_samples_leaf=300, random_state=42)
...
y_test_pre = random_forest_regressor.predict(x_test)
